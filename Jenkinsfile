pipeline {
    ...
    stage('Deploy') {
      ...
      post {
        success {
          ...
          mail to: 'selvakumar@cogzidel.com', subject: 'New build available!', body: 'Check it out!'
        }
      }
    }
  }
  post {
    failure {
      ...
      mail to: 'selvakumar@cogzidel.com', subject: 'Oops!', body: "Build ${env.BUILD_NUMBER} failed; ${env.BUILD_URL}"
    }
  }
}